...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-300 to-indigo-200 py-10">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 ease-in-out transform hover:scale-105"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-900 transition duration-200 ease-in-out transform hover:scale-105"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="py-3 px-6 bg-blue-900 text-white rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 ease-in-out transform hover:scale-105"
            >
